...
Namespace ChartLegend
    ...
    Public Partial Class Form1
        ...
        Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs)
            ...
            Dim strip1 As Strip = New Strip("Strip 1")
            ...
            chartControl1.Legend.Border.Visible = True
            ...
            chartControl1.Legend.Antialiasing = False
            chartControl1.Legend.Font = New Font(Font.FontFamily.Name, 9, FontStyle.Bold)
